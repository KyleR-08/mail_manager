...
// Una cuenta guarda: email del usuario, proveedor (gmail/outlook/institutional),
// ruta del archivo de token OAuth2 y metadatos básicos.
...
type Account struct {
	...
	ProviderType string `json:"provider_type"` // Tipo: "gmail", "outlook" o "institutional"
